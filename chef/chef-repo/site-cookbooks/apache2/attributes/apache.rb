...
set_unless[:apache][:contact] = "sysadmin@gilmation.com"
set_unless[:apache][:timeout] = 60
...
set_unless[:apache][:traceenable] = "Off"
...
set_unless[:apache][:prefork][:maxclients] = 150
set_unless[:apache][:prefork][:maxrequestsperchild] = 10000

# Worker Attributes
set_unless[:apache][:worker][:startservers] = 2
set_unless[:apache][:worker][:maxclients] = 150
set_unless[:apache][:worker][:minsparethreads] = 25
set_unless[:apache][:worker][:maxsparethreads] = 75
